					...
					<div class="panel-body">
						<form action="" method="post">
					    	<div class="part" style="margin-right: 10%;">
					    		<div>
					    			CIN : 
						    		<input type="text" class="form-control" style="width: 60%;display: inline-block; margin-left: 10px;" placeholder="CNI" name="cin">
						    	</div>
						    	<div>
						    		Nom : 
...
glyphicon glyphicon-floppy-disk"></span>Enregistrer</button>
					<button type="submit" class="btn btn-primary"><span class="
glyphicon glyphicon-th-list" name="listeetudiants"></span>Retourner a la liste d'etudiants</button>
